...
output_dir = f'result_ratio_{Modelname}_single_DRIAMS-UMG_E{EPOCH}_B{batch_size}_L{LATENT_SIZE}'
...
def main():
    ...
    for mix_ratio in [x/10.0 for x in range(1,6)]:
        ...
        output_suffix = f'{Modelname}_train_Single_test_single_mixed_{mix_ratio}'
        ...
        #
        # mixed test run
        output_suffix = f'{Modelname}_train_Single_test_mixed_{mix_ratio}'

...
output_dir = f'result_single_DRIAMS-UMG_E{EPOCH}_B{batch_size}_L{LATENT_SIZE}'
...
def main():
    ...
    model_scripted.save(f'./{output_dir}/resmlp_driams_Train_Mixed2_Epochs_{EPOCH}_Seed_{SEED}.pt')
